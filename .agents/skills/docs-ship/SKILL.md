...
Repo: `F:/Personal/CommunityProjects/libraries/xperience-search`. Wiki: `git@github.com:jkerb135/xperience-community-lucene-instant-search.wiki.git`. Scope every glob to `docs/` and `src/` — `.Codex/worktrees/` holds full stale repo copies.
