...
// machine-wide cache would serve yesterday's XperienceCommunity.Search.* instead of what we packed.
...
if (!existsSync(join(feed, 'XperienceCommunity.Search.Widgets.0.1.0.nupkg'))) {
