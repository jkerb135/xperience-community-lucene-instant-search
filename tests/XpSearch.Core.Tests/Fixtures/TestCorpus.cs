...
internal static class TestCorpus
{
    ...
    [
        new("doc-1:en", "Espresso Basics", "Brewing espresso requires pressure and patience.", "Article", "en", "/articles/espresso-basics", ["coffee"], ["brewing", "coffee"], null, 1_700_000_000),
        new("doc-2:en", "Latte Art", "Steamed milk poured into espresso.", "Article", "en", "/articles/latte-art", ["coffee"], ["milk"], null, 1_700_000_100),
        ...
        new("doc-4:en", "Coffee Grinder", "A burr grinder for consistent coffee grounds.", "Product", "en", "/products/coffee-grinder", ["equipment"], ["grinding"], 149.5, 1_690_000_100),
        ...
        new("doc-6:de", "Espresso Grundlagen", "Espresso braucht Druck.", "Article", "de", "/de/artikel/espresso", ["coffee"], ["brewing"], null, 1_700_000_200),
