...
public sealed class XpSearchTuningModuleInstaller
{
    ...
    public XpSearchTuningModuleInstaller(IInfoProvider<ResourceInfo> resources)
    {
    ...
    public static FormInfo RuleForm()
    {
        ...
        Add(form, nameof(XpSearchRuleInfo.RuleTargetObjectID), FieldDataType.Text, size: 450, allowEmpty: true);
        Add(form, nameof(XpSearchRuleInfo.RuleTargetPosition), FieldDataType.Integer);
        Add(form, nameof(XpSearchRuleInfo.RuleBoostValue), FieldDataType.Decimal, size: 18, precision: 4);
        Add(form, nameof(XpSearchRuleInfo.RuleFilterExpression), FieldDataType.LongText, allowEmpty: true);
        Add(form, nameof(XpSearchRuleInfo.RuleRedirectUrl), FieldDataType.Text, size: 450, allowEmpty: true);
