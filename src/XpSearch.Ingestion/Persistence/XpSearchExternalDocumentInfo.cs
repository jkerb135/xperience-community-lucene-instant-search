...
// IInfoProvider<XpSearchExternalDocumentInfo> to the container and the application fails DI validation
...
[assembly: RegisterObjectType(typeof(XpSearchExternalDocumentInfo), XpSearchExternalDocumentInfo.OBJECT_TYPE)]
